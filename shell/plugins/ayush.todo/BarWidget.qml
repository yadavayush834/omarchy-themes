...
BarWidget {
  ...
  property string statusText: "󰄬"
  property string statusTooltip: "Open todo list"
  ...
  function applyStatus(raw) {
    try {
      ...
      statusText = String(data.text || "󰄬")
      statusTooltip = String(data.tooltip || "Open todo list")
      pendingCount = Number(data.pending || 0)
    } catch (e) {
      statusText = "󰄬"
      statusTooltip = "Open todo list"
      pendingCount = 0
    }
  }
